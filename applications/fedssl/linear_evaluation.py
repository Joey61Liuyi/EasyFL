...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default='./saved_models/local_simclr/local_simclr_global_model_r_0_f0000000.pth', type=str, help="Path to pre-trained model (e.g. model-10.pt)")
